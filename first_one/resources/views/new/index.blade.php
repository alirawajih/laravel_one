...
<head>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
     <link rel="stylesheet" href="css/stayle.css"><!--{{url('css/stayle.css')}} -->
  ...
  <body class="body"  >
    ...
    <div class="container mt-5  ">
        ...
        @foreach($data as $SomeData)
              ...
              <a href="{{route('new.show',['new'=>$SomeData['id']])}}">
                <div class="p-3 border bg-light cord" >
                    <img class="img-fluid"  src="imges/{{$SomeData['imges']}}" alt="imge">
                    <h5 class="text-black-50">{{$SomeData['title']}}</h5>
                    <h3 >{{$SomeData['name']}} </h3>
                    <h6 class="fw-lighter">{{$SomeData['sub']}}</h6>
                      ...
                      <ul class="d-flex mt-4 list-unstyled  gap-1 " >
                        ...
                        <li>
                            ...
                            <img src="imges/instegram.png" class="img-fluid" alt=""></i>
                        </a>
                      </ul>
                </div>
                </a>
